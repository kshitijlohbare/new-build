...
const Sidebar = ({ onNavigate }: SidebarProps) => {
  ...
  const navItems = [
    ...
    { name: "enhanced practices", path: "/practices-enhanced", selectedIcon: "/src/assets/icons/Practice_selected.svg", nonSelectedIcon: "/src/assets/icons/Practice_nonselected.svg" },
