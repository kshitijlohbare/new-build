...
const NewDailyPractices = () => {
  ...
  // These state variables are used in useEffect below
  const [, setShowAnimation] = useState(false);
  const [, setAnimationData] = useState<any>(null);
  // We're using this as a placeholder for future implementation
              ...
              <div className="relative w-20 h-20">
                <svg viewBox="0 0 36 36" className="w-full h-full">
                  ...
                  <path
                    ...
                    strokeLinecap="round"
                  />
                  <text x="18" y="21" textAnchor="middle" fill="#148BAF" fontSize="10" fontFamily="Happy Monkey">
...
export default NewDailyPractices;
