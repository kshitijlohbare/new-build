...
const PractitionerDetail: React.FC = () => {
    ...
    return (
      <div className="flex justify-center items-center min-h-screen">
        <div className="text-center">
          ...
          <p className="text-xl text-[#148BAF] font-happy-monkey">Loading practitioner details...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="sticky top-0 z-50 bg-white border-b border-gray-200 px-4 py-3 sm:px-6">
        <div className="flex items-center justify-between max-w-4xl mx-auto">
          <button
            onClick={() => navigate('/therapist-listing')}
            className="flex items-center gap-2 text-[#148BAF] font-medium text-sm hover:text-[#04C4D5] transition-colors"
          >
          ...
          <div className="flex items-center gap-2">
            <button className="p-2 text-gray-600 hover:text-[#148BAF] transition-colors">
              <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-4xl mx-auto px-4 pb-24 sm:px-6 lg:pb-8">
        ...
        <div className="bg-gradient-to-br from-[#E6F9FA] to-[#F0F9FF] rounded-2xl p-6 mb-6 -mt-2">
          <div className="flex flex-col sm:flex-row items-center gap-6">
            ...
            <div className="relative flex-shrink-0">
              ...
              {/* Badge */}
              {practitioner.badge && (
                <div className="absolute -top-2 -right-2 px-3 py-1 bg-[#04C4D5] text-white text-xs font-medium rounded-full shadow-md">
                  {practitioner.badge}
                </div>
              )}
            ...
            <div className="flex-1 text-center sm:text-left">
              <h1 className="text-2xl md:text-3xl font-happy-monkey font-bold text-[#148BAF] mb-2 leading-tight">
                {practitioner.name}
              </h1>
              <p className="text-base text-gray-700 mb-3 font-medium">{practitioner.specialty}</p>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center sm:justify-start gap-3 mb-4">
                <div className="flex items-center gap-2">
                  <div className="flex text-yellow-400">
                    {[...Array(5)].map((_, i) => (
                      <svg 
                        key={i} 
                        className={`w-5 h-5 ${i < Math.floor(practitioner.rating) ? 'fill-current' : 'fill-gray-300'}`}
                        viewBox="0 0 24 24"
                      >
                ...
                <div className="flex items-center gap-2">
                  <span className="px-3 py-1 bg-white bg-opacity-70 text-[#148BAF] text-sm font-medium rounded-full">
              ...
              <div className="bg-white bg-opacity-70 rounded-xl p-4 inline-block">
                <div className="text-2xl font-bold text-[#148BAF]">
                  ₹{practitioner.price}
                  <span className="text-sm font-normal text-gray-600 ml-1">/session</span>
                </div>
                <p className="text-xs text-gray-600 mt-1">Starting from initial consultation</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-3 mb-6">
          <button className="flex flex-col items-center gap-2 p-4 bg-white rounded-xl shadow-sm border border-gray-100 hover:border-[#04C4D5] transition-all">
            <div className="w-10 h-10 bg-[#E6F9FA] rounded-full flex items-center justify-center">
              <svg className="h-5 w-5 text-[#148BAF]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button 
            ...
            className="flex flex-col items-center gap-2 p-4 bg-gradient-to-br from-[#04C4D5] to-[#148BAF] rounded-xl shadow-md hover:shadow-lg transition-all"
          >
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            <h2 className="text-xl font-happy-monkey font-bold text-[#148BAF] mb-4 flex items-center gap-2">
              <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex items-start gap-3">
                <div className="w-8 h-8 bg-[#E6F9FA] rounded-lg flex items-center justify-center flex-shrink-0">
                  <svg className="h-4 w-4 text-[#148BAF]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
                <div>
                  <h3 className="font-semibold text-[#148BAF] mb-1">Experience</h3>
                  <p className="text-gray-600 text-sm">{practitioner.years_experience} years</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-[#148BAF] mb-1">Education</h3>
                  <p className="text-gray-600 text-sm">{practitioner.education}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-[#148BAF] mb-1">Approach</h3>
                  <p className="text-gray-600 text-sm">{practitioner.approach}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-[#148BAF] mb-1">Languages</h3>
                  <p className="text-gray-600 text-sm">{practitioner.languages?.join(', ')}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
              {practitioner.conditions.map((condition, index) => (
                <div
                  key={index}
                  className="bg-gradient-to-r from-[#E6F9FA] to-[#F0F9FF] text-[#148BAF] px-4 py-3 rounded-xl text-sm font-medium text-center border border-[rgba(4,196,213,0.2)] hover:shadow-md transition-all"
                >
                  {condition}
                </div>
              ))}
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            ...
            <div className="space-y-4">
              {sessionTypes.map((type) => (
                <div 
                  key={type.id}
                  className="border border-gray-200 rounded-xl p-4 hover:border-[#04C4D5] hover:shadow-md transition-all"
                >
                  <div className="flex justify-between items-start mb-2">
                    <h3 className="font-semibold text-gray-900">{type.name}</h3>
                    <div className="text-right">
                      <span className="text-lg font-bold text-[#148BAF]">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-[#148BAF] mb-1">Availability</h3>
                  <p className="text-gray-600 text-sm">{practitioner.availability}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-[#148BAF] mb-1">Session Formats</h3>
                  <div className="flex flex-wrap gap-2 mt-2">
                    {practitioner.session_format?.map((format, index) => (
                      <span key={index} className="px-3 py-1 bg-[#E6F9FA] text-[#148BAF] text-xs rounded-full">
                        {format}
                      </span>
                    ))}
                  </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-[#148BAF] mb-1">Insurance Accepted</h3>
                  <div className="flex flex-wrap gap-2 mt-2">
      ...
      <div className="fixed bottom-6 left-4 right-4 z-40 md:hidden">
        <button
          onClick={() => setIsBookingOpen(true)}
          className="w-full bg-gradient-to-r from-[#04C4D5] to-[#148BAF] text-white font-happy-monkey text-lg py-4 rounded-2xl shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-3"
        >
        ...
        <DialogContent className="w-full max-w-lg mx-4 max-h-[85vh] overflow-y-auto rounded-2xl p-0">
          ...
          <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 rounded-t-2xl">
            <DialogHeader className="text-left">
              <DialogTitle className="text-xl font-happy-monkey font-bold text-[#148BAF] flex items-center justify-between">
              ...
              <div className="flex items-center gap-2 mt-3">
                <div className={`w-8 h-2 rounded-full ${bookingStep === 'type' ? 'bg-[#04C4D5]' : bookingStep !== 'type' ? 'bg-[#04C4D5]' : 'bg-gray-300'}`}></div>
                <div className={`w-8 h-2 rounded-full ${bookingStep === 'datetime' ? 'bg-[#04C4D5]' : bookingStep === 'video' || bookingStep === 'confirm' ? 'bg-[#04C4D5]' : 'bg-gray-300'}`}></div>
                <div className={`w-8 h-2 rounded-full ${bookingStep === 'video' ? 'bg-[#04C4D5]' : bookingStep === 'confirm' ? 'bg-[#04C4D5]' : 'bg-gray-300'}`}></div>
                <div className={`w-8 h-2 rounded-full ${bookingStep === 'confirm' ? 'bg-[#04C4D5]' : 'bg-gray-300'}`}></div>
              </div>
          ...
          <div className="px-6 py-6">
            ...
            {bookingStep === 'type' && (
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-gray-900">Choose your session type</h3>
                    ...
                    <button
                      ...
                      className={`w-full p-4 rounded-2xl border-2 transition-all text-left ${
                        selectedSessionType === type.id 
                          ? 'border-[#04C4D5] bg-[#E6F9FA]' 
                          : 'border-gray-200 hover:border-[#04C4D5] hover:bg-gray-50'
                      }`}
                    >
                      <div className="flex justify-between items-start mb-2">
                        <h4 className="font-semibold text-[#148BAF]">{type.name}</h4>
                        <span className="text-lg font-bold text-[#148BAF]">
                          {type.price === 0 ? 'FREE' : type.price || `₹${practitioner.price}`}
                        </span>
                      </div>
            ...
            {bookingStep === 'datetime' && (
              <div className="space-y-6">
                ...
                <div>
                  <h4 className="font-medium mb-3 text-gray-700">Available dates</h4>
                      ...
                      return (
                        <button
                          ...
                          className={`p-3 rounded-xl border-2 transition-all ${
                            selectedDate === date 
                              ? 'border-[#04C4D5] bg-[#E6F9FA] text-[#148BAF]' 
                              : 'border-gray-200 hover:border-[#04C4D5] text-gray-700'
                          }`}
                        >
                ...
                {selectedDate && (
                  <div>
                    <h4 className="font-medium mb-3 text-gray-700">Available times</h4>
                    <div className="grid grid-cols-3 gap-3">
            ...
            {bookingStep === 'video' && (
              <div className="space-y-6">
                <h3 className="text-lg font-semibold text-gray-900">Video meeting setup</h3>
                <VideoCallSetup
            ...
            {bookingStep === 'confirm' && (
              <div className="space-y-6">
                ...
                <div className="bg-gradient-to-br from-[#E6F9FA] to-[#F0F9FF] rounded-2xl p-6 border border-[rgba(4,196,213,0.2)]">
                  <div className="space-y-4">
                    ...
                    <div className="border-t border-[rgba(4,196,213,0.3)] pt-4 flex justify-between items-center">
                      <span className="text-lg font-bold text-[#148BAF]">Total</span>
                      <span className="text-2xl font-bold text-[#148BAF]">
                ...
                <div className="bg-white border border-gray-200 rounded-xl p-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm text-gray-700">Secure video session</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <button
                ...
                className={`flex-1 py-3 px-4 font-medium rounded-xl transition-colors ${
                  ...
                  (bookingStep === 'video' && !videoMeetingDetails)
                    ...
                    : 'bg-gradient-to-r from-[#04C4D5] to-[#148BAF] text-white hover:shadow-lg'
                }`}
              >
