...
const TherapistListing = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white mx-4 md:mx-8 -mt-6 rounded-xl shadow-lg border border-gray-100 mb-6 relative z-10">
        <div className="p-4 md:p-6">
          ...
          <div className="relative mb-4">
            ...
            <button 
              ...
              className="absolute right-2 top-2 w-8 h-8 bg-[#04C4D5] rounded-md flex items-center justify-center text-white hover:bg-[#148BAF] transition-colors"
            >
          ...
          <div className="flex gap-3">
            ...
            <div className="relative">
              <button 
                ...
                className="px-4 py-2 border border-gray-200 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 flex items-center gap-2 min-h-[40px]"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="flex flex-col gap-4">
                    <h4 className="text-[#148BAF] text-base font-medium flex items-center">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="mr-2">
                        <path d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2Z" fill="#148BAF"/>
                      </svg>
          ...
          <div className="p-4 md:p-6">
            {loading ? (
              ...
              <div className="text-center py-12 md:py-16">
                ...
                <div className="text-xl font-medium text-[#148BAF]">Finding perfect matches for you...</div>
              </div>
              ...
              <div className="text-center py-12 md:py-16 max-w-md mx-auto px-4">
                <div className="bg-[rgba(4,196,213,0.1)] p-6 rounded-2xl mb-4">
                  <svg width="64" height="64" className="mx-auto mb-4 text-[#04C4D5]" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M9 12L11 14L15 10M21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                  <h3 className="text-xl font-medium text-[#148BAF] mb-3">No therapists found matching your criteria</h3>
                  <p className="text-gray-600 text-base mb-5">
                    We couldn't find any therapists that match your current filters.
                  </p>
                  <button 
                    onClick={handleResetFilters}
                    className="px-6 py-3 bg-gradient-to-r from-[#04C4D5] to-[#148BAF] text-white rounded-md font-medium transition-all hover:shadow-lg"
                  >
                    Show all therapists
                  </button>
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                {practitioners.map((practitioner) => (
                  <div
                    key={practitioner.id}
                    className="bg-white rounded-2xl p-5 relative group hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-[#04C4D5] hover:-translate-y-1 cursor-pointer"
                    onClick={(e) => {
                  ...
                  >
                    {/* Image with badge */}
                    <div className="relative rounded-xl overflow-hidden h-48 mb-4 bg-gradient-to-br from-[#E6F9FA] to-[#F7FFFF] group-hover:shadow-md transition-all">
                      ...
                      {practitioner.badge && (
                        <div className="absolute top-3 left-3 px-3 py-1 bg-white/90 backdrop-blur-sm rounded-lg border border-[#04C4D5]/20 shadow-sm">
                          <span className="text-[#148BAF] text-xs font-medium flex items-center">
                    ...
                    <div className="flex justify-between items-start mb-3 gap-3">
                      <div className="flex-1 min-w-0">
                        <h3 className="font-semibold text-lg text-[#148BAF] group-hover:text-[#0A7A9A] transition-colors truncate mb-1">
                          {practitioner.name}
                        </h3>
                      ...
                      <div className="bg-gradient-to-r from-[#E6F9FA] to-[#F7FFFF] px-3 py-1.5 rounded-lg border border-[#04C4D5]/20 text-[#148BAF] text-sm font-semibold flex-shrink-0">
                        ${practitioner.price}
                    ...
                    {practitioner.conditions && practitioner.conditions.length > 0 && (
                      <div className="mb-4 flex flex-wrap gap-2">
                        {practitioner.conditions.slice(0, 2).map((condition, index) => (
                          <span 
                            key={index} 
                            className="bg-[#04C4D5]/10 text-[#148BAF] text-xs px-2.5 py-1 rounded-full font-medium"
                          >
                            {condition}
                          </span>
                        ))}
                        {practitioner.conditions.length > 2 && (
                          <span className="text-[#148BAF] text-xs font-medium">+{practitioner.conditions.length - 2} more</span>
                        )}
                      </div>
                    )}
                    ...
                    <div className="flex items-center gap-2 mb-4">
                      <div className="w-5 h-5 flex-shrink-0 text-[#04C4D5]">
                      ...
                      <span className="text-[#148BAF] text-sm font-medium truncate">
                    ...
                    <div className="flex items-center justify-between mb-5">
                      ...
                      <span className="text-xs px-2.5 py-1 bg-[#04C4D5]/10 text-[#148BAF] rounded-full font-medium">
                    ...
                    {/* Book button */}
                    <button 
                      className="w-full px-4 py-3 bg-gradient-to-r from-[#04C4D5] to-[#148BAF] hover:from-[#03b1c1] hover:to-[#0f7a99] text-white rounded-lg font-medium transition-all duration-300 shadow-[0_4px_12px_rgba(4,196,213,0.3)] hover:shadow-[0_6px_16px_rgba(4,196,213,0.4)] transform group-hover:scale-105"
                      onClick={(e) => {
                        e.stopPropagation();
