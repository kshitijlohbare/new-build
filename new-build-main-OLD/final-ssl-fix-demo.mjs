// Final demonstration of the SSL fix with daily practice update
// Import the SSL workaround first - this is the key to making the solution work
import './src/lib/ssl-workaround.js';

// Import Supabase after the SSL workaround
import { createClient } from '@supabase/supabase-js';

const supabaseUrl = 'https://svnczxevigicuskppyfz.supabase.co';
const supabaseKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InN2bmN6eGV2aWdpY3Vza3BweWZ6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDQwNDk1NDAsImV4cCI6MjA1OTYyNTU0MH0.00MNZRYjGKHTEFvF0enW-VCZ4qgDnXC4LeV8XsjGaEU';

// Create the Supabase client - no need to explicitly disable SSL, the workaround did that already
...
async function runDemo() {
  ...
  console.log('Checking if Node.js environment:', typeof window === 'undefined');
