...
import { savePracticeData, loadPracticeData, addToDailyPractices, removeFromDailyPractices } from './practiceUtils.fixed';
    ...
    const loadUserData = async () => {
      ...
      if (user?.id) {
        try {
          ...
          // Try to load user data using the improved function that checks both Supabase and localStorage
